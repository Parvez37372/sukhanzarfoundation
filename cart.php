                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-12 pr-lg-4">
                            ...
                            <div class="cart-actions mb-6 pt-4">
                                <a href="javascript:void(0);" class="btn btn-dark btn-md btn-rounded btn-icon-left mr-4 mb-4"><i
                                        class="d-icon-arrow-left"></i>Continue Shopping</a>
                                <button type="submit"
                                    class="btn btn-outline btn-dark btn-md btn-rounded ">Update
                                    Cart</button>
                            </div>
                            ...
                            <div class="sticky-sidebar" data-sticky-options="{'bottom': 20}">
                                <div class="summary mb-4">
                                    ...
                                    <!-- <div class="shipping-address">
                                        ...
                                        <a href="javascript:void(0);" class="btn btn-md btn-dark btn-rounded btn-outline">Update
                                            totals</a>
                                    </div> -->
                                    <table class="total">
                                        <tr class="summary-subtotal">

...
// ✅ Only poets who have gazals (sher_count > 0)
$sql = "SELECT id, name, image, dob, dod, location, sher_count 
...
<div class="container mt-4">
    <h2 class="mb-4">📖 Urdu Shaiyari Collection</h2>
            ...
            <a href="poet.php?id=<?= $row['id']; ?>" style="text-decoration:none; color:inherit;">
                <div class="post-card">
                    ...
                    <div class="post-info">
                        ...
                        <span class="badge">Shaiyari: <?= $row['sher_count']; ?></span>
                    </div>
                </div>
            </a>
        <?php } 

...
<div class="user-area ptb-100 mt-5">
  <div class="container">
    <div class="row align-items-center">
      <div class="col-lg-6">
        <div class="account1">
          <div class="log_log">
            <form action="login.php" method="post" class="login" id="login_form">
  <h3 class="text-center mt-3">Member Login</h3>
  ...
  <div class="forget">
    <a class="font-xs color-gray-500 mt-3" href="forget_password.php">Forgot your password?</a>
  </div>

  <div class="d-flex m-auto justify-content-between log_reg">
    <button type="submit" class="btn common-btn text-center mt-3">Login</button>
  </div>

  <h5 class="mt-5 font-xs text-center">Don't have an account? <a href="signup.php">Sign Up</a></h5>
</form>
          ...
          <div class="register_log">
            <form action="signup-handler.php" method="post" class="login formSubmit" id="login_form">
              ...
              <div class="d-flex m-auto justify-content-between log_reg">
                <button type="submit" class="btn common-btn text-center re_login">Register</button>
              ...
              <h5 class="mt-5 font-xs text-center">Have already an account? <a href="javascript:;" class="log_rfrm">Login</a></h5>
            </form>
          </div>

          <div class="user-item otpVerify">
                ...
                <form method="POST" id="verifyOtpForm" class="otp-form">
                  <div class="customer-login-register">
                    <div class="login-form">
                      ...
                      <div class=" form-fild text-center">
                      ...
                      <div class="register-submit">
                        <button type="submit" class="form-button btn common-btn mt-3 " id="otpsubmit" name="submit">Verify</button>
                      </div>
...
<script>
  ...
  $('.registerfrm').click(function() {
    $('.register_log').show(200);
    $('.log_log').hide();
    $('.otpVerify').hide();
  })
  $('.log_rfrm').click(function() {
    $('.log_log').show();
    $('.register_log').hide(200);
    $('.otpVerify').hide();
  })

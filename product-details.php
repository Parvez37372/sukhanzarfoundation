				...
				<div class="container">
								...
								<div
									...
									<figure class="product-image">
										<img src="assets/images/shop/13.jpg"
											data-zoom-image="assets/images/shop/13.jpg"
								...
								<div class="product-thumbs-wrap">
									<div class="product-thumbs">
										<div class="product-thumb active">
											<img src="assets/images/shop/13.jpg" alt="product thumbnail"
							...
							<div class="product-details">
								<div class="product-navigation">
									<ul class="breadcrumb breadcrumb-lg">
										<li><a href="javascript:;"><i class="d-icon-home"></i></a></li>
								...
								<h1 class="product-name">Coast Pool Comfort Jacket</h1>
								<div class="product-meta">
									SKU: <span class="product-sku">12345670</span>
									BRAND: <span class="product-brand">The Northland</span>
								</div>
								<div class="product-price">Rs. 113.00</div>
								<div class="ratings-container">
									<div class="ratings-full">
										<span class="ratings" style="width:80%"></span>
										<span class="tooltiptext tooltip-top"></span>
									</div>
									<a href="javascript:void(0);product-tab-reviews" class="link-to-tab rating-reviews">( 11 reviews )</a>
								</div>
								...
								<div class="product-form product-variations product-size">
									...
									<div class="product-form-group">
										...
										<a href="javascript:void(0);" class="product-variation-clean" style="display: none;">Clean All</a>
									</div>
								</div>
								...
								<div class="product-footer">
									<div class="social-links mr-4">
										...
										<a href="javascript:void(0);" class="social-link social-pinterest fab fa-pinterest-p"></a>
									</div>
									<span class="divider d-lg-show"></span>
									<a href="javascript:void(0);" class="btn-product btn-wishlist mr-6"><i class="d-icon-heart"></i>Add to
										wishlist</a>
									<a href="javascript:void(0);" class="btn-product btn-compare"><i class="d-icon-compare"></i>Add
										to
										compare</a>
								</div>
							</div>
					...
					<div class="tab tab-nav-simple product-tabs">
						<ul class="nav nav-tabs justify-content-center" role="tablist">
							<li class="nav-item">
								<a class="nav-link active" href="javascript:void(0);product-tab-description">Description</a>
							</li>
							<!-- <li class="nav-item">
								<a class="nav-link" href="javascript:void(0);product-tab-additional">Additional information</a>
							</li>
							<li class="nav-item">
								<a class="nav-link" href="javascript:void(0);product-tab-size-guide">Size Guide</a>
							</li> -->
							<li class="nav-item">
								<a class="nav-link" href="javascript:void(0);product-tab-reviews">Reviews (2)</a>
							</li>
						</ul>
							...
							<div class="tab-pane" id="product-tab-reviews">
								<div class="row">
									<div class="col-lg-4 mb-6">
										...
										<a class="btn btn-dark btn-rounded submit-review-toggle" href="javascript:void(0);">Submit
											Review</a>
									</div>
										...
										<nav class="toolbox">
											<div class="toolbox-left">
												<div class="toolbox-item">
													<a href="javascript:void(0);" class="btn btn-outline btn-rounded">All Reviews</a>
												</div>
												<div class="toolbox-item">
													<a href="javascript:void(0);" class="btn btn-outline btn-rounded">With Images</a>
												</div>
												<div class="toolbox-item">
													<a href="javascript:void(0);" class="btn btn-outline btn-rounded">With Videos</a>
												</div>
											</div>
													...
													<div class="comment-body">
														...
														<div class="file-input-wrappers">
															...
															<img class="btn-play btn-img pwsp"
																src="assets/images/products/product1.jpg" width="280"
																height="315" alt="product" />


															<img class="btn-play btn-img pwsp"
																src="assets/images/products/product3.jpg" width="280"
																height="315" alt="product" />

															<a class="btn-play btn-iframe"
																style="background-image: url(assets/images/product/product.jpg);background-size: cover;"
										...
										<nav class="toolbox toolbox-pagination justify-content-end">
											<ul class="pagination">
												<li class="page-item disabled">
													<a class="page-link page-link-prev" href="javascript:void(0);" aria-label="Previous"
												...
												<li class="page-item page-item-dots"><a class="page-link" href="javascript:void(0);">6</a>
												</li>
												<li class="page-item">
									...
									<div class="review-form-wrapper">
										...
										<div class="rating-form">
											...
											<span class="rating-stars selected">
												...
												<a class="star-4 active" href="javascript:void(0);">4</a>
					...
					<section class="pt-3 mt-10">
						...
						<div class="owl-carousel owl-theme owl-nav-full row cols-2 cols-md-3 cols-lg-4"
							...
							<div class="product">
								<figure class="product-media">
									...
									<div class="product-action-vertical">
										...
										<a href="javascript:void(0);" class="btn-product-icon btn-wishlist" title="Add to wishlist"><i
								...
								<div class="product-details">
									...
									<h3 class="product-name">
										<a href="javascript:void(0);">Solid Pattern in Summer Dress</a>
									</h3>
									...
									<div class="ratings-container">
										...
										<a href="javascript:void(0);" class="rating-reviews">( <span class="review-count">12</span>
											reviews
											)</a>
									</div>
								</div>
							...
							<div class="product">
								...
								<div class="product-details">
									<div class="product-cat">
										<a href="javascript:void(0);">Bags & Backpacks</a>
									</div>
									<h3 class="product-name">
										<a href="javascript:void(0);">Mackintosh Poket Backpack</a>
									</h3>
									<div class="product-price">
										<ins class="new-price">Rs. 125.99</ins><del class="old-price">Rs. 160.99</del>
									</div>
									<div class="ratings-container">
										<div class="ratings-full">
											<span class="ratings" style="width:60%"></span>
										...
										<a href="javascript:void(0);" class="rating-reviews">( <span class="review-count">6</span> reviews
											)</a>
									</div>
								</div>
							</div>
							<div class="product">
								...
								<div class="product-details">
									...
									<h3 class="product-name">
										<a href="javascript:void(0);">Fashionable Orginal Trucker</a>
									</h3>
									<div class="product-price">
										<span class="price">Rs. 78.64</span>
									</div>
									<div class="ratings-container">
										<div class="ratings-full">
											<span class="ratings" style="width:40%"></span>
										...
										<a href="javascript:void(0);" class="rating-reviews">( <span class="review-count">2</span> reviews
											)</a>
									</div>
								</div>
							</div>
							<div class="product">
								...
								<div class="product-details">
									...
									<h3 class="product-name">
										<a href="javascript:void(0);">Women Red Fur Overcoat</a>
									</h3>
									<div class="product-price">
										<span class="price">Rs. 184.00</span>
									</div>
									<div class="ratings-container">
										<div class="ratings-full">
											<span class="ratings" style="width:80%"></span>

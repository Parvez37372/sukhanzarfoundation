				...
				<div class="container mt-7">
					<div class="card accordion">
						<div class="alert alert-light alert-primary alert-icon mb-4 card-header">
							...
							<a href="javascript:void(0);alert-body1" class="text-primary collapse">Click here to login</a>
						</div>
						<div class="alert-body collapsed" id="alert-body1">
							...
							<div class="checkbox d-flex align-items-center justify-content-between">
								...
								<a href="javascript:void(0);" class="lost-link">Lost your password?</a>
							</div>
							<div class="link-group">
								<a href="javascript:void(0);" class="btn btn-dark btn-rounded mb-4">Login</a>
								<span class="d-inline-block text-body font-weight-semi-bold">or Login With</span>
								<div class="social-links mb-4">
									<a href="javascript:void(0);" class="social-link social-google fab fa-google"></a>
					...
					<div class="card accordion">
						<div class="alert alert-light alert-primary alert-icon mb-4 card-header">
							...
							<a href="javascript:void(0);alert-body2" class="text-primary">Click here to enter your code</a>
						</div>
									...
									<div class="summary pt-5">
										...
										<table class="order-table">
											...
											<tbody>
												<tr>
													...
													<td class="product-total text-body">Rs. 110.00</td>
												</tr>
												<tr>
													<td class="product-name">Mackintosh Poket backpack <span
															class="product-quantity">×&nbsp;1</span></td>
													<td class="product-total text-body">Rs. 180.00</td>
												</tr>
												<tr class="summary-subtotal">
													<td>
														<h4 class="summary-subtitle">Subtotal</h4>
													</td>
													<td class="summary-subtotal-price pb-0 pt-0">Rs. 290.00
													</td>
												</tr>
												...
												<tr class="summary-total">
													...
													<td class=" pt-0 pb-0">
														<p class="summary-total-price ls-s text-primary">Rs. 290.00</p>
													</td>
												</tr>
											</tbody>
										</table>
										...
										<div class="form-checkbox mt-4 mb-5">
											...
											<label class="form-control-label" for="terms-condition">
												I have read and agree to the website <a href="javascript:void(0);">terms and conditions
												</a>*
											</label>
										</div>
										
									<a href="place-order.php" class="btn btn-dark btn-rounded btn-order">Place
											Order </a>

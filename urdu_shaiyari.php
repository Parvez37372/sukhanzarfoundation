...
echo '<button type="submit" style="margin-top:8px; background:#ee089c; color:#fff; padding:8px 12px; border:none; border-radius:6px; cursor:pointer;">Post Comment</button>';
echo '</form>';
        ...
        echo '
                <div class="reply-box" id="reply-box-' . $commentId . '" style="display:none; margin-top:10px;">
                    <form method="POST" action="post_reply.php">
                        ...
                        <button type="submit" style="margin-top:5px; padding:6px 12px; background:#ee089c; color:#fff; border:none; border-radius:6px;">Post Reply</button>
                    </form>
                </div>
            </div>
        </div>';

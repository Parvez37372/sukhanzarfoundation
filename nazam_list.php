...
// ✅ Only poets who have gazals (nazam_count > 0)
$sql = "SELECT id, name, image, dob, dod, location, nazam_count 
            ...
            <a href="poet.php?id=<?= $row['id']; ?>" style="text-decoration:none; color:inherit;">
                <div class="post-card">
                    ...
                    <div class="post-info">
                        ...
                        <span class="badge">Nazam: <?= $row['nazam_count']; ?></span>
                    </div>
                </div>
            </a>
        <?php } 

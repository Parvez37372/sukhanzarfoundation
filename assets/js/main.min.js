  ...
  (function () {
    ...
    (Riode.$window = $(window)),
      ...
      (Riode.isOnScreen = function (e, t, i) {
        ...
        return (
          r + a.height + l >= o &&
          r <= o + window.innerHeight + l &&
          s + a.width + d >= n &&
          s <= n + window.innerWidth + d
        );
      }),
        ...
        function i(e) {
          ...
          if (
            ...
            if ("undefined" != typeof PhotoSwipe) {
              var s = $(".pswp")[0],
                r = new PhotoSwipe(s, PhotoSwipeUI_Default, n, {
                  index: a,
                  closeOnScroll: !1,
                });
              r.init(), (Riode.photoswipe = r);
            }
          }
        }
        function n(e) {
        ...
        return {
          ...
          open: function (n, r) {
            ...
            c.isPurchased
              ...
              (d = $(Riode.parseTemplate(c.template, c))),
              (l.space = c.space),
              (d.appendTo(e).css("top", -t).find("img")[0].onload =
                function () {
                  (t += d[0].offsetHeight + l.space),
                    d.addClass("show"),
                    d.offset().top - window.pageYOffset < 0 &&
                      (l.close(),
                      d.css("top", -t + d[0].offsetHeight + l.space)),
                    d
